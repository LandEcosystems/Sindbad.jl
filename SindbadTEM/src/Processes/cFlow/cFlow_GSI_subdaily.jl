...
@bounds @describe @units @timescale @with_kw struct cFlow_GSI_subdaily{T1,T2,T3,T4,T5} <: cFlow
    ...
    k_shedding::T3 = 0.14 | (0.033, 0.33) | "rate of shedding" | "fraction" | ""
...
purpose(::Type{cFlow_GSI_subdaily}) = "Carbon transfer rates between pools based on the GSI approach, using stressors such as soil moisture, temperature, and light."
...
*Versions*
 - 1.0 on 19.09.2026 [xshan]: initial implementation of subdaily GSI approach
