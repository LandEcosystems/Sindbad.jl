...
function define(params::cCropHarvestEvent_forcing, forcing, land, helpers)
	return land
end

function precompute(params::cCropHarvestEvent_forcing, forcing, land, helpers)
	return land
end
...
function update(params::cCropHarvestEvent_forcing, forcing, land, helpers)
	return land
end
