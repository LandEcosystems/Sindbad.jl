export cQualityPartitioncMic_none

struct cQualityPartitioncMic_none <: cQualityPartitioncMic end

function define(params::cQualityPartitioncMic_none, forcing, land, helpers)
    @unpack_nt begin
...
function precompute(params::cQualityPartitioncMic_none, forcing, land, helpers)
...
purpose(::Type{cQualityPartitioncMic_none}) = "Applies no soil-property preference: soil-microbial decomposition divides equally between old soil carbon and the remaining pathway."

@doc """

	$(getModelDocString(cQualityPartitioncMic_none))
...
*Versions*
 - 1.0 on 04.09.2026 [skoirala]: as the cMicSoil half of cQualityPartitionSoilProperties_none
