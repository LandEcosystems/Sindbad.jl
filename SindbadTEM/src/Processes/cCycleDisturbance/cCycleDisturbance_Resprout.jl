export cCycleDisturbance_Resprout

#! format: off
struct cCycleDisturbance_Resprout <: cCycleDisturbance end
#! format: on

function define(params::cCycleDisturbance_Resprout, forcing, land, helpers)
    @unpack_nt begin
...
function compute(params::cCycleDisturbance_Resprout, forcing, land, helpers)
    ## unpack forcing
...
purpose(::Type{cCycleDisturbance_Resprout}) = "Moves carbon in all vegetation pools except reserve to their respective carbon flow target pools during disturbance events, allowing recovery from the surviving reserve pool."

@doc """

$(getModelDocString(cCycleDisturbance_Resprout))
