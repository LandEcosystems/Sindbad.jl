...
@bounds @describe @units @timescale @with_kw struct gpp_JSBACH{T1,T2,T3,T4,T5} <: gpp
	P1::T1 = 0.1 | (-Inf, Inf) | "parameter 1" | "parameter 1 unit" | "parameter 1 timescale"
...
function compute(params::gpp_JSBACH, forcing, land, helpers)
	...
	gpp = P1 # this is just a placeholder. Replace with actual calculation of GPP based on JSBACH.
